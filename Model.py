...
class ModelSystem(object):
    def __init__(self, env):
        self.state_x, self.state_y = env.get_state_size()  # n, n
        self.action_size = env.get_action_size()  # n*n+1
        
        self.input = Input(shape=(self.state_x, self.state_y))
        imaged_input = Reshape((self.state_x, self.state_y, 1))(self.input)  # add channel axis to last.
